//! This module generates AST datatype used by minecraft. It is _heavily_
//! inspired from rust-analyzer's:
...
pub fn sourcegen_ast() {
  ...
  let ast_tokens_file = sourcegen::project_root().join("mc-syntax/src/ast/generated/tokens.rs");
  sourcegen::ensure_file_contents(ast_tokens_file.as_path(), &ast_tokens);

  let ast_nodes = generate_nodes(&ast);
  let ast_nodes_file = sourcegen::project_root().join("mc-syntax/src/ast/generated/nodes.rs");
